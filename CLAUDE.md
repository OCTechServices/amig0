...
- [ ] P05: health/ disposition — DECISION RECORDED 2026-09-24. Temporary: health/ remains in current location for remainder of Phase 1. Long-term: separate health/ from amig0 public product boundary (owner: Daniel; timing: post-Phase-1 housekeeping, before any intentional expansion of health/ functionality). NOTE: phase-1-scope.md §Exit Criteria requires "owner + date" for formal deferral — lifecycle milestone does not satisfy the date requirement. Daniel must provide a concrete deferral date before P05 can be formally closed for Phase 1 exit.
