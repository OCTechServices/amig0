    ...
    container.innerHTML = [
      '<div class="dashboard">',
        '<div class="stat-grid" id="stat-grid">',
          statCard('stat-clients',  'Total ' + cfg('clients'),                  '—'),
          statCard('stat-tours',    'Active ' + cfg('tours'),                  '—'),
          statCard('stat-upcoming', 'Upcoming ' + cfg('tours') + ' (30 days)', '—'),
          statCard('stat-balance',  'Outstanding Balance',                      '—'),
        '</div>',
        '<div class="dashboard-lower">',
          '<div class="card" id="recent-tours-card">',
            '<h3 class="card-title">Recent ' + cfg('tours') + '</h3>',
            '<div id="recent-tours-body" class="card-body">Loading…</div>',
          '</div>',
          '<div class="card" id="recent-clients-card">',
            '<h3 class="card-title">Recent ' + cfg('clients') + '</h3>',
